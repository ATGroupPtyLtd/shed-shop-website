...
export const metadata: Metadata = {
  ...
  description:
    "Explore real residential, agricultural, commercial and architectural shed projects across Victoria.",
};
    ...
    <main>
      ...
      <section className="portfolio-page shell section-space">
        <div className="portfolio-intro">
          ...
          <p>
            Filter the complete original Shed Shop image collection by the kind
            of outcome you are planning. Select any project for a closer view.
          </p>
        </div>
        <ProjectGallery />
      </section>
